...
for (var i = 0; i < x.length; i++) {
    ...
    var doit = false;
    console.log(action, amount, compare, operator, opwith);

    if (registers[compare] == undefined) {
        registers[compare] = 0;
    }

    switch (operator) {
        case ">":
            doit = registers[compare] > opwith;
            break;
        case "<":
            doit = registers[compare] < opwith;
            break;
    ...
    console.log(doit, action, amount);
    if (doit) {
        if (action == "inc") {
